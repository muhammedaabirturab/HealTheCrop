...
CROP_PROFILES = {
    ...
    "pomegranate": dict(N=(19, 8),  P=(18, 8),  K=(40, 10), temperature=(21, 3), humidity=(90, 4), ph=(6.4, 0.5), rainfall=(105, 20), season="Kharif"),
    "banana":      dict(N=(100, 15),P=(82, 12), K=(50, 12), temperature=(27, 3), humidity=(80, 5), ph=(5.9, 0.4), rainfall=(105, 25), season="Kharif"),
    "mango":       dict(N=(20, 8),  P=(27, 8),  K=(30, 10), temperature=(31, 3), humidity=(50, 8), ph=(5.7, 0.5), rainfall=(95, 20),  season="Kharif"),
    "grapes":      dict(N=(23, 8),  P=(132, 15),K=(200, 15),temperature=(24, 4), humidity=(81, 5), ph=(6.0, 0.4), rainfall=(70, 15),  season="Rabi"),
    ...
    "orange":      dict(N=(19, 8),  P=(16, 8),  K=(10, 6),  temperature=(22, 3), humidity=(92, 4), ph=(6.4, 0.4), rainfall=(110, 20), season="Rabi"),
    "papaya":      dict(N=(50, 12), P=(59, 12), K=(50, 12), temperature=(33, 3), humidity=(92, 4), ph=(6.7, 0.4), rainfall=(145, 25), season="Kharif"),
    "coconut":     dict(N=(21, 8),  P=(16, 8),  K=(30, 10), temperature=(27, 2), humidity=(94, 3), ph=(5.9, 0.4), rainfall=(175, 25), season="Kharif"),
    ...
    "coffee":      dict(N=(101, 15),P=(28, 8),  K=(30, 10), temperature=(25, 3), humidity=(58, 8), ph=(6.8, 0.4), rainfall=(155, 25), season="Kharif"),
    ...
    "sugarcane":    dict(N=(150, 15), P=(60, 10), K=(120, 15), temperature=(28, 3), humidity=(75, 6), ph=(6.5, 0.4), rainfall=(150, 25), season="Zaid"),
    "tea":          dict(N=(90, 12),  P=(30, 8),  K=(60, 10),  temperature=(22, 3), humidity=(85, 5), ph=(5.0, 0.4), rainfall=(220, 30), season="Kharif"),
    ...
    "guava":        dict(N=(20, 8),   P=(20, 8),  K=(30, 10),  temperature=(25, 3), humidity=(65, 8), ph=(6.5, 0.4), rainfall=(100, 20), season="Rabi"),
    ...
    "blackpepper":  dict(N=(40, 10),  P=(30, 8),  K=(60, 10),  temperature=(25, 3), humidity=(85, 5), ph=(5.8, 0.4), rainfall=(200, 25), season="Kharif"),
    "cardamom":     dict(N=(30, 8),   P=(30, 8),  K=(60, 10),  temperature=(22, 3), humidity=(85, 5), ph=(5.8, 0.4), rainfall=(250, 30), season="Kharif"),
